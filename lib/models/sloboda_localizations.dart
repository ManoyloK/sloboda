...
class RandomEventLocalizations extends InternalLocalizations {
  Map<String, Map<String, String>> _localizedMap = {
    ...
    'uk': {
      ...
      'HelpDefendSichYes': 'Загін козаків вирушив разом з січовиками на Січ.',
      'HelpDefendSichNo':
      ...
      'successSendMerchantToKanev':
          'Валка з товаром з успіхом дійшла до Канева. Продавши всю рибу і хутра, вона вирушила назад.',
      'failureSendMerchantToKanev':
...
class SlobodaLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    ...
    'uk': {
      ...
      'noAvailableTasks': 'Немає доступних задач',
    }
  };
  ...
  static String get noAvailableTasks {
    return _localizedValues[SlobodaLocalizations.locale.languageCode]
        ['noAvailableTasks'];
  }
}
